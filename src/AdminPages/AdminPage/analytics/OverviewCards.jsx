...
const overviewData = [
  ...
  { name: "Guests", value: "45,678", change: 8.3, icon: Users },
  { name: "Bookings", value: "9,876", change: -3.2, icon: CalendarCheck },
  { name: "Room Views", value: "1,234,567", change: 15.7, icon: Eye },
];
